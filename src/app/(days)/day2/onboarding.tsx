...
const onboardingSteps = [{
    icon: 'lightbulb',
    title: 'Welcome to Daily Spark',
    description: "Spark Every Day: Igniting My Creative Flame (Focuses on inspiration, growth)",
},
{
    icon: 'people-arrows',
...
},
{
    ...
    description: "Daily coding challenges, tech discussions, and project collaborations to enhance your skills",
}]
